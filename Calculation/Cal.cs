...
public static class AKG{ 
    private static List<string> AKG_header = ["UsiaKurangDari", "BB(Kg)", "TB (cm)", "Energi", "Protein", "Total", "Omega3", "Omega6", "Karbohidrat", "Serat", "Air"];
    private static List<List<float>> AKGT_Child  = [// [UsiaKurangDari, BB, TB, Energi, Protein, Total, Omega3, Omega6, Karbohidrat, Serat, Air]
...
public static class Logic{
    ...
    /// <summary>
    /// Find does the username exist in the table users
    /// </summary>
